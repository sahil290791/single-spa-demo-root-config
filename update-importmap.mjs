...
const url = `https://sahil-single-spa-demo.s3.ap-south-1.amazonaws.com/%40sahil-mfa/single-spa-demo-root-config/${process.env.TRAVIS_COMMIT}/sahil-mfa-root-config.js`
